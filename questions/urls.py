...
urlpatterns = [
    ...
    path('questions/toggle/', toggle_question_status, name='toggle_question'),
    # urls for questions from question management views
    path('<slug:slug>/add_question/', add_question_view, name='add_question_in_quiz'),
    # urls for options
    path('<slug:slug>/<int:question_id>/add_option/', add_option_view, name='add_option_in_quiz'),
